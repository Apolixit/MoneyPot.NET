...
namespace MoneyPot_RestService.Generated.Controller
{
    ...
    public sealed class SudoController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Key")]
        [ProducesResponseType(typeof(MoneyPot_NetApiExt.Generated.Model.sp_core.crypto.AccountId32), 200)]
        [StorageKeyBuilder(typeof(MoneyPot_NetApiExt.Generated.Storage.SudoStorage), "KeyParams")]
