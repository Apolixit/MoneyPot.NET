...
namespace MoneyPot_BlazorFront.Repository
{
    ...
    public static class AccountStorage
    {
        ...
        // Secret Key URI `//Bob//stash` is account:
        // Network ID:        substrate
        // Secret seed:       0x1a7d114100653850c65edecda8a9b2b4dd65d900edef8e70b1a6ecdcda967056
        // Public key(hex):  0xfe65717dad0447d715f660a0a58411de509b42e6efb8375f562f58a554d5860e
        // Account ID:        0xfe65717dad0447d715f660a0a58411de509b42e6efb8375f562f58a554d5860e
        // Public key(SS58): 5HpG9w8EBLe5XCrbczpwq5TSXvedjrBGCwqxK1iQ7qUsSWFc
        // SS58 Address:      5HpG9w8EBLe5XCrbczpwq5TSXvedjrBGCwqxK1iQ7qUsSWFc
        ...
        // Secret Key URI `//Apo` is account:
        // Network ID:        substrate
        // Secret seed:       0x235325ea0be509cbee6dad8944688d78d865f8418e0a570b2dd16deef6a9538c
        // Public key(hex):  0x804cda9ff442f63dc4f202c3abed618876bff2b7713fc5e7764073e9727e277f
        // Account ID:        0x804cda9ff442f63dc4f202c3abed618876bff2b7713fc5e7764073e9727e277f
        // Public key(SS58): 5ExvpL19R3qd88jsRdncjLgaj3znUe6jczKsSjxS1DEM6SvD
        // SS58 Address:      5ExvpL19R3qd88jsRdncjLgaj3znUe6jczKsSjxS1DEM6SvD

        // https://www.flaticon.com/free-icons/avatar
        private static List<(string name, string ss58Address, string publicKey, string secretSeed)> _accounts;
        public static List<(string name, string ss58Address, string publicKey, string secretSeed)> Accounts
        {
            get
            {
                if (_accounts == null)
                {
                    _accounts = new List<(string name, string ss58Address, string publicKey, string secretSeed)>()
                    {
                        ...
                        ("Alice_Stash", "5GNJqTPyNqANBkUVMN1LPPrxXnFouWXoe2wNSmmEoLctxiZY", "0xbe5ddb1579b72e84524fc29e78609e3caf42e85aa118ebfe0b0ad404b5bdd25f", "0x3c881bc4d45926680c64a7f9315eeda3dd287f8d598f3653d7c107799c5422b3"),
                        ...
                        ("Bob_Stash", "5HpG9w8EBLe5XCrbczpwq5TSXvedjrBGCwqxK1iQ7qUsSWFc", "0xfe65717dad0447d715f660a0a58411de509b42e6efb8375f562f58a554d5860e", "0x1a7d114100653850c65edecda8a9b2b4dd65d900edef8e70b1a6ecdcda967056"),
                        ("Apo", "5ExvpL19R3qd88jsRdncjLgaj3znUe6jczKsSjxS1DEM6SvD", "0x804cda9ff442f63dc4f202c3abed618876bff2b7713fc5e7764073e9727e277f", "0x235325ea0be509cbee6dad8944688d78d865f8418e0a570b2dd16deef6a9538c"),
                        ("Charlie", "5FLSigC9HGRKVhB9FiEo4Y3koPsNmBmLJbpXg2mp1hXcS59Y", "0x90b5ab205c6974c9ea841be688864633dc9ca8a357843eeacf2314649965fe22", "0xbc1ede780f784bb6991a585e4f6e61522c14e1cae6ad0895fb57b9a205a8f938"),
        ...
        public static (string name, string ss58Address, string publicKey, string secretSeed) FromDto(AccountDto account)
        {
            // Todo : check if not found
            return Accounts.FirstOrDefault(x => x.ss58Address == account.Address);
        }
