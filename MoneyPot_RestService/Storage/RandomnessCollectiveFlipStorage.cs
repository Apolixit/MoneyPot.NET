...
namespace MoneyPot_RestService.Generated.Storage
{
    ...
    public interface IRandomnessCollectiveFlipStorage : IStorage
    {
        ...
        ///  the oldest hash.
        /// </summary>
        MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT1 GetRandomMaterial();
    }
    ...
    public sealed class RandomnessCollectiveFlipStorage : IRandomnessCollectiveFlipStorage
    {
        ...
        /// </summary>
        private TypedStorage<MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT1> _randomMaterialTypedStorage;
        ...
        {
            this.RandomMaterialTypedStorage = new TypedStorage<MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT1>("RandomnessCollectiveFlip.RandomMaterial", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _randomMaterialTypedStorage property
        /// </summary>
        public TypedStorage<MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT1> RandomMaterialTypedStorage
        {
            get
            {
        ...
        ///  the oldest hash.
        /// </summary>
        public MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT1 GetRandomMaterial()
        {
