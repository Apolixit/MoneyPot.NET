...
namespace MoneyPot_RestService.Generated.Storage
{
    ...
    public interface IBalancesStorage : IStorage
    {
        ...
        /// </summary>
        MoneyPot_NetApiExt.Generated.Model.pallet_balances.AccountData GetAccount(string key);
        ...
        /// </summary>
        MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT2 GetLocks(string key);
        
        /// <summary>
        /// >> Reserves
        ///  Named reserves on some account balances.
        /// </summary>
        MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT3 GetReserves(string key);
        ...
        /// </summary>
        MoneyPot_NetApiExt.Generated.Model.pallet_balances.EnumReleases GetStorageVersion();
    }
    ...
    public sealed class BalancesStorage : IBalancesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<MoneyPot_NetApiExt.Generated.Model.pallet_balances.AccountData> _accountTypedStorage;
        
        /// <summary>
        /// _locksTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT2> _locksTypedStorage;
        
        /// <summary>
        /// _reservesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT3> _reservesTypedStorage;
        
        /// <summary>
        /// _storageVersionTypedStorage typed storage field
        /// </summary>
        private TypedStorage<MoneyPot_NetApiExt.Generated.Model.pallet_balances.EnumReleases> _storageVersionTypedStorage;
        ...
        public BalancesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.StorageVersionTypedStorage = new TypedStorage<MoneyPot_NetApiExt.Generated.Model.pallet_balances.EnumReleases>("Balances.StorageVersion", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<MoneyPot_NetApiExt.Generated.Model.pallet_balances.AccountData> AccountTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT2> LocksTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT3> ReservesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<MoneyPot_NetApiExt.Generated.Model.pallet_balances.EnumReleases> StorageVersionTypedStorage
        {
            get
            {
        ...
        ///  NOTE: This is only used in the case that this pallet is used to store balances.
        /// </summary>
        public MoneyPot_NetApiExt.Generated.Model.pallet_balances.AccountData GetAccount(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountTypedStorage.Dictionary.TryGetValue(key, out MoneyPot_NetApiExt.Generated.Model.pallet_balances.AccountData result))
            {
                return result;
            }
            else
        ...
        ///  NOTE: Should only be accessed when setting, changing and freeing a lock.
        /// </summary>
        public MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT2 GetLocks(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LocksTypedStorage.Dictionary.TryGetValue(key, out MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT2 result))
            {
                return result;
            }
            else
        ...
        ///  Named reserves on some account balances.
        /// </summary>
        public MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT3 GetReserves(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReservesTypedStorage.Dictionary.TryGetValue(key, out MoneyPot_NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT3 result))
            {
                return result;
            }
            else
        ...
        ///  This is set to v2.0.0 for new networks.
        /// </summary>
        public MoneyPot_NetApiExt.Generated.Model.pallet_balances.EnumReleases GetStorageVersion()
        {
